...
try:
    ...
    print("No se encontró una instalación de PyGame!")

# Dimensiones de pantalla y laberinto
BORDERTHICKNESS = 20
WALLTHICKNESS = 8
MAZE_WIDTH = 640
MAZE_HEIGHT = 480
...
WALL_COLOR = BLUE
BULLETS_MAX = 6     # Máximo de balas en pantalla
...
# Direcciones de movimiento/disparo
